...
public class Languages {
    ...
    public static ArrayList<Lang> getLanguage(){
        ArrayList<Lang> language=new ArrayList<>();
        language.add(new Lang("ENGLISH","en"));
        language.add(new Lang("PUNJABI","pa"));
        language.add(new Lang("HINDI","hi"));
        language.add(new Lang("MALAY","ms"));
        language.add(new Lang("BENGALI","bn"));
        language.add(new Lang("TAMIL","ta"));
        language.add(new Lang("TELUGU","te"));
        language.add(new Lang("URDU","ur"));
